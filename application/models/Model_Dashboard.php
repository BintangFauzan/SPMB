...
class Model_Dashboard extends CI_Model
{
	...
	public function get_total_tk()
	{
		$this->db->from("lps_pendaftar");
		$this->db->where('dft_level', 1);
		$query = $this->db->get();

		return $query->num_rows();
	}

	public function get_total_sd()
	{
		$this->db->from("lps_pendaftar");
		$this->db->where('dft_level', 2);
		$query = $this->db->get();

		return $query->num_rows();
	}

	public function get_total_smp()
	{
		$this->db->from("lps_pendaftar");
		$this->db->where('dft_level', 3);
		$query = $this->db->get();
