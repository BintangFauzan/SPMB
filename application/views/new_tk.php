...
:root {
    ...
    --nav-hover-color: #F9AA75 !important;
    ...
    --nav-dropdown-hover-color: #F9AA75 !important;
...
<main class="main">
        ...
        <div class="container">
            <div class="row gy-4 justify-content-center justify-content-lg-between">
                ...
                <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
                    <img style="width: 100%;" src="<?= base_url("assets/");?>new-asset/assets/img/hero-tk.png"
    ...
    <section id="about" class="about section">
        ...
        <div class="container section-title" data-aos="fade-up">
            <!-- <h2>About Us<br></h2> -->
            <img class="img-fluid w-50" src="<?= base_url("assets/");?>new-asset/assets/img/thumb-tk.png" alt="">
        ...
        <div class="container">
            ...
            <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-lg-12 d-flex align-items-center reservation-form-bg" data-aos="fade-up"
                    data-aos-delay="200">
                    <form role="form" class="php-email-form" id="form_daftar_tk">
                        <input type="hidden" id="dft_id" name="dft_id" value="">
                        <input type="hidden" id="dft_level" name="dft_level" value="1">
                        <div class="row gy-4">
                        ...
                        <!-- <div class="col-lg-12 col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input type="file" accept=".jpg, .jpeg, .png" class="filestyle" id="dft_transfer"
                                        name="dft_transfer" data-buttonname="btn-white" onchange="previewImg()">
                                </div>
                            </div>
                        </div> -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" form="form_daftar_tk" data-bs-dismiss="modal" style="background-color: var(--accent-color); border-color: var(--accent-color);">Ya, Yakin</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row gy-3">
            <div class="col-lg-3 col-md-6 d-flex">
                ...
                <div class="address">
                    <h4>Alamat</h4>
                    <a href="https://www.google.com/maps/place/Sekolah+Tahfizh+Plus+Khoiru+Ummah+Pekanbaru+%5BPAUD-TK%5D/@0.4853219,101.4184698,20.5z/data=!4m12!1m5!3m4!2zMMKwMjknMDcuMiJOIDEwMcKwMjUnMDYuOSJF!8m2!3d0.485345!4d101.418589!3m5!1s0x31d5a8e44cbd6c0b:0x9e6fe0dba8c9f36d!8m2!3d0.4852547!4d101.4183722!16s%2Fg%2F11c5g5qc81?entry=ttu&g_ep=EgoyMDI1MTAwNy4wIKXMDSoASAFQAw%3D%3D"
                        target="_blank" style="text-decoration: none; color: white;">
                        Jl. Soekarno Hatta, Komplek Ruko Gardenia Depan RS. Eka Hospital
                        Delima, Kec. Tampan, Kota Pekanbaru, Riau 28292</a>
                    <p></p>
                </div>
            ...
            <div class="col-lg-3 col-md-6 d-flex">
                ...
                <div>
                    <h4>Kontak </h4>
                    <p>
                        <strong> Admin TK KU :</strong> <span> <a href="https://wa.me/628116502019" target="_blank"> +62
                                811-6502-019</a> </span><br>
                        <strong> Mudir TK KU :</strong> <span> <a href="https://wa.me/6285219442007" target="_blank">
                                +62 852-1944-2007</a> </span><br>
            ...
            <div class="col-lg-3 col-md-6 d-flex">
                ...
                <div>
                    <h4>Jam Buka</h4>
                    <p>
                        <strong>Senin - Jum'at:</strong> <span>08.00 - 11.00</span><br>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="social-links d-flex">
                    ...
                    <a href="https://www.instagram.com/khoiruummahpku_tk" target="_blank" class="instagram"><i
