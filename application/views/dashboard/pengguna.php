				...
				<div class="modal-body form">
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label>Level</label>
								<select class="form-control" name="log_level" id="log_level" onChange="get_role(this.value)">
									<option value="">== Pilih Level ==</option>
									<option value="2">Admin Semua</option>
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label>Role</label>
								<select class="form-control" name="log_role" id="log_role">
...
<script>
	...
	function get_role(id) {
		var id_level = decodeURIComponent(id);
		if (id == 4) {
			$("#log_role").html("<option value=''>== Pilih Role ==</option><option value='1'>TK</option><option value='2'>SD</option><option value='3'>SMP</option>><option value='4'>SMA</option>");
		} else {
			$("#log_role").html("<option value=''>== Pilih Role ==</option>");
		}
	}
