...
:root {
    ...
    --nav-hover-color: #A8CF45 !important;
    ...
    --nav-dropdown-hover-color: #A8CF45 !important;
...
<main class="main">
        ...
        <div class="container">
            <div class="row gy-4 justify-content-center justify-content-lg-between">
                ...
                <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
                    <img src="<?= base_url("assets/");?>new-asset/assets/img/hero-sd.png" class="img-fluid animated"
                        alt="">
                </div>
            </div>
        </div>
    ...
    <section id="about" class="about section">
        ...
        <div class="container section-title" data-aos="fade-up">
            <!-- <h2>About Us<br></h2> -->
            <img class="img-fluid w-50" src="<?= base_url("assets/");?>new-asset/assets/img/thumb-sd.png" alt="">
            <p style="font-family: sans-serif; font-size: 1.5rem; font-weight:bold;"><span>Kenapa Harus</span> <br>
                <span class="description-title">STP Khoiru Ummah?</span></p>
    ...
    <section id="register" class="book-a-table section">
        ...
        <div class="container section-title" data-aos="fade-up">
            ...
            <p style="font-family: sans-serif; font-size: 1.5rem; font-weight:bold;"><span>Ayo Daftar di</span> <br>
                <span class="description-title">Khoiru Ummah<br></span></p>
        </div><!-- End Section Title -->
        ...
        <div class="container">
            ...
            <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-lg-12 d-flex align-items-center reservation-form-bg" data-aos="fade-up"
                    data-aos-delay="200">
                    <form role="form" class="php-email-form" id="form_daftar_sd">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" form="form_daftar_sd" data-bs-dismiss="modal" style="background-color: var(--accent-color); border-color: var(--accent-color);">Ya, Yakin</button>
            </div>
        </div>
    </div>
</div>
...
<footer id="footer" class="footer dark-background">
    ...
    <div class="container">
        <div class="row gy-3">
            <div class="col-lg-3 col-md-6 d-flex">
                ...
                <div class="address">
                    <h4>Alamat</h4>
                    <a href="https://www.google.com/maps/place/Sekolah+Tahfizh+Plus+Khoiru+Ummah+Pekanbaru+%5BTingkat+Dasar%5D/@0.4696167,101.4041468,17z/data=!4m10!1m2!2m1!1ssd+khoiru+ummah!3m6!1s0x31d5a8e5ed2af8d7:0x613be62338299875!8m2!3d0.4696843!4d101.4043186!15sCg9zZCBraG9pcnUgdW1tYWiSARByZWxpZ2lvdXNfc2Nob29sqgFNEAEqEyIPc2Qga2hvaXJ1IHVtbWFoKCYyHxABIhs2-SXvjpLgbWvGmprV5PednthfSfnNn1waDmkyExACIg9zZCBraG9pcnUgdW1tYWjgAQA!16s%2Fg%2F11c3kycwcm?entry=ttu&g_ep=EgoyMDI1MTAwNy4wIKXMDSoASAFQAw%3D%3D"
                        target="_blank" style="text-decoration: none; color: white;">
                      Jl. Delima Gg. Khoiru Ummah, No. 3-6, Kel. Tobek Godang, Kec. Binawidya, Kota Pekanbaru, Riau 28295</a>
                    <p></p>
                </div>
            ...
            <div class="col-lg-3 col-md-6 d-flex">
                ...
                <div>
                    <h4>Kontak </h4>
                    <p>
                        <strong> Admin SD KU :</strong> <span> <a href="https://wa.me/6281311994452" target="_blank"> +62 813-1199-4452</a> </span><br>
                        <strong> Mudir SD KU :</strong> <span> <a href="https://wa.me/6282392163578" target="_blank">
                                +62 823-9216-3578</a> </span><br>
            ...
            <div class="col-lg-3 col-md-6 d-flex">
                ...
                <div>
                    <h4>Jam Buka</h4>
                    <p>
                        <strong>Senin - Jum'at:</strong> <span>07.15 - 15.00</span><br>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="social-links d-flex">
                    <a href="https://fb.com/pekanbaru.khoiruummah" target="_blank" class="facebook"><i class="bi bi-facebook"></i></a>
                    <a href="https://www.instagram.com/khoiruummahpku_sd" target="_blank" class="instagram"><i
    ...
    <div class="container copyright text-center mt-4">
        <p>© <script>
            ...
            </script> Sekolah Tahfizh Plus Khoiru Ummah Pekanbaru, All Right Reserved.</p>
        <div class="credits">
