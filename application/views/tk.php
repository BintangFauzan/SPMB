  ...
  <div class="container-fluid p-0 pb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="owl-carousel header-carousel position-relative">
      <div class="owl-carousel-item position-relative">
        <img class="img-fluid" src="<?= base_url("assets"); ?>/img/14.png" alt="">
          ...
          <div class="container">
            <div class="row justify-content-start">
              <div class="col-lg-8">
                ...
                <a href="#daftar" class="btn btn-primary rounded-pill py-3 px-5">Daftar</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row g-5">
        <div class="col-lg-6 align-self-center wow fadeInUp" data-wow-delay="0.05s">
          <h1 style="font-size: 40px;">
            <span style="color: #FF6600;">Kenapa Harus</span><br> STP Khoiru Ummah?
          </h1>
        ...
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.05s">
          <img class="img-fluid rounded img_program" src="<?= base_url("assets"); ?>/img/9.png" alt="">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container-xxl py-6" id="daftar">
    <div class="container">
      <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
        ...
        <h1 style="color: #FF6600;">Khoiru Ummah</h1>
      </div>
      <div class="row g-4">
        <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
          <div class="fact-item bg-light rounded h-100 p-5">
            <form class="form-group" id="form_daftar_tk">
              ...
              <div class="text-center">
                <button type="submit" id="simpan_tk" class="btn btn-primary text-light" style="width: 150px;">Simpan</button>
              </div>
            </form>
          </div>
        </div>
  ...
  <!-- Facts End -->
  <!-- Footer Start -->
  <div class="container-fluid text-dark footer my-6 mb-0 py-5 wow fadeIn" style="background-color: #FFC172;" data-wow-delay="0.1s">
