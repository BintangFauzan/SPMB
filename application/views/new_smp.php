...
:root {
    ...
    --nav-dropdown-hover-color: #56357F !important;
...
<main class="main">
        ...
        <div class="container">
            <div class="row gy-4 justify-content-center justify-content-lg-between">
                ...
                <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
                    <img src="<?= base_url("assets/");?>new-asset/assets/img/hero-smp.png" class="img-fluid animated"
                        alt="">
                </div>
            </div>
        </div>
    ...
    <section id="about" class="about section">
        ...
        <div class="container section-title" data-aos="fade-up">
            <!-- <h2>About Us<br></h2> -->
            <img class="img-fluid w-50" src="<?= base_url("assets/");?>new-asset/assets/img/thumb-smp.png" alt="">
        ...
        <div class="container">
            ...
            <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-lg-12 d-flex align-items-center reservation-form-bg" data-aos="fade-up"
                    data-aos-delay="200">
                    <form role="form" class="php-email-form" id="form_daftar_smp">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" form="form_daftar_smp" data-bs-dismiss="modal" style="background-color: var(--accent-color); border-color: var(--accent-color);">Ya, Yakin</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row gy-3">
            <div class="col-lg-3 col-md-6 d-flex">
                ...
                <div class="address">
                    ...
                    <a href="https://www.google.com/maps/place/Pondok+Pesantren+Tahfizh+Plus+Khoiru+Ummah+Pekanbaru/@0.4173468,101.2739704,15z/data=!4m10!1m2!2m1!1sponpes+khoiru+ummah!3m6!1s0x31d5075775a43397:0x7c972a843827308d!8m2!3d0.4173468!4d101.2853002!15sChNwb25wZXMga2hvaXJ1IHVtbWFokgEQcmVsaWdpb3VzX3NjaG9vbKoBPBABMh8QASIbNvkkKXfsMB0bC-N43n5P-8jzakZ1XfeYQNApMhcQAiITcG9ucGVzIGtob2lydSB1bW1haOABAA!16s%2Fg%2F11crzgvzmm?entry=ttu&g_ep=EgoyMDI1MTAwNy4wIKXMDSoASAFQAw%3D%3D"
                       ...
                       Jl. Raya Pekanbaru - Bangkinang No.KM 24, Rimba Panjang, Kec. Tambang, Kabupaten Kampar, Riau 28468</a>
                    <p></p>
                </div>
            ...
            <div class="col-lg-3 col-md-6 d-flex">
                ...
                <div>
                    <h4>Kontak </h4>
                    <p>
                        <strong> Admin SMP KU :</strong> <span> <a href="https://wa.me/6282324987785" target="_blank"> +62 823-2498-7785</a> </span><br>
                        <strong> Mudir SMP KU :</strong> <span> <a href="https://wa.me/6281312109978" target="_blank">
